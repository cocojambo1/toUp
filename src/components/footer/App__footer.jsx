...
import s from './App__footer.module.scss'
        ...
        <div className={ s.wrap } >
            <div className={ s.container } >
                <div className={ s.text } >
                    <p className={ s.description } > ToUp studio - команда разработчиков, маркетологов и дизайнеров с большим опытом работы </p>

                    <p className={ s.info } > © 2019 - 2020 Copyright ToUp Studio </p>
                </div>

                <a href="https://vk.com/toup.studio" target='_blank' >
